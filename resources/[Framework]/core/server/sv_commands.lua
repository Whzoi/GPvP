...
RegisterCommand("radio", function(source, args)
    ...
    if not args[1] then
        -- TriggerClientEvent('chat:addMessage', source, { args = { "SYSTEM", "Usage: /radio [frequency number]" } })
        exports['notifications']:SendAlert('error', 'Usage: /radio [Freq 1 - 999]', 1500)
    ...
    if not frequency or frequency < 0 then
         TriggerEvent('chat:addMessage', { args = { 'Server', 'Invalid radio frequency.'} })
